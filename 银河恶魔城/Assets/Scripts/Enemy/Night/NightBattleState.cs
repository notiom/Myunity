...
public class NightBattleState : EnemyState
{
	private Transform player;
	private Enemy_Night enemy;


	public NightBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Night _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
	{
		this.enemy = _enemy;
	}
